...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        map[titleList[0]] = listOf("Darxonbek", "Jamshid", "Abdulbori")
        map[titleList[1]] = listOf("Muhammad Yusuf", "Muhammad Umar")
        map[titleList[2]] = listOf("va boshkalar")
